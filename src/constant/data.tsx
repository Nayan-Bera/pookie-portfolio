...
export const PERSONAL_INFO = {
  ...
  resume: "/resume/Srilekha-Paul-Resume.pdf",
};
...
export const PROJECTS = [
...

  {
    ...
    description:
      "Developed a modern responsive jewelry e-commerce platform with product collections, shopping cart functionality, Firebase integration, checkout system, customer reviews, and elegant UI/UX design.",
    technologies: [
      "React.js",
      "JavaScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    description:
      "Developed a full-stack college community platform that helps students connect, share resources, manage academic discussions, and access important college updates.",
    technologies: [
      "Next.js",
      "React.js",
      "TypeScript",
...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    description: [
      ...
      "Collaborated with team members to enhance usability.",
    ],
  },
  {
    role: "Web Developer Intern",
    ...
    description: [
      ...
      "Gained practical frontend workflow experience.",
    ],
  },
];
...
export const CONTACT = {
  ...
  linkedin: "https://www.linkedin.com/in/srilekha-paul5515/",
